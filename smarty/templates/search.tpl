...
<div id="search-content-wrapper">
	<div id="search-search-wrapper">
	  <form name="search-search" action="index.php" method="get">
	...
	<div id="search-example">
	  {t}E.g.{/t}: <a href="index.php?address={t escape='url'}Bartonova 951, 547 01 Nachod{/t}">	  {t}Bartonova 951, 547 01 Nachod{/t}</a>, <a href="index.php?address={t escape='url'}331 01{/t}">{t}331 01{/t}</a>, <a href="index.php?address={t escape='url'}Ostrava{/t}">{t}Ostrava{/t}</a>
	</div>
</div>
{/block}

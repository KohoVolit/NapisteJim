...
<div id="page-footer">
  <div id="front-social">
	 ...
	 <div style="float:left;">
	  ...
	  <div class="fb-like" data-send="false" data-layout="button_count" data-width="140" data-show-faces="true" style="bottom:1px;">
	  </div>
	  
	  <!--google+-->
	  <g:plusone annotation="inline" size="small" width="170"></g:plusone>

{t escape=no 1=$smarty.const.WTT_TITLE 2=$mp.first_name 3=$mp.last_name}%2 %3 responded to your message sent through
%1 website. You can find the response below.{/t}

{if $message.is_public == 'yes'}{t escape=no 1=$smarty.const.WTT_TITLE }Because your message was sent as a public one, the response is published
